...
public class ListViewAdapterRelatedProduct extends BaseAdapter {
    ...
    public ListViewAdapterRelatedProduct(Context context,
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View itemView = inflater.inflate(R.layout.list_view_related_product, parent, false);
        // Get the position
        ...
        name.setText(resultp.get("related_product_name"));
        //price.setText("HKD:" + resultp.get("price"));

        // Capture position and set results to the ImageView
        // Passes flag images URL into ImageLoader.class
        imageLoader.DisplayImage(resultp.get("related_product_image"), rImage);
        ...
        itemView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                System.out.println("The product id is: " + resultp.get("related_product_product_id"));
                Intent intent = new Intent(context, ProductDetailsActivity.class);
                intent.putExtra("product_id", resultp.get("related_product_product_id"));
